...
def draw_detections(request, stream="main"):
    ...
    with MappedArray(request, stream) as m:
        ...
        cv2.rectangle(m.array, (frame_center[0] - delta, frame_center[1] - delta),
                      (frame_center[0] + delta, frame_center[1] + delta), (255, 255, 255), thickness=2)
        ...
        for detection in detections:
            ...
            # Draw detection box with dot at center
